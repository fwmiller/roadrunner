...
static void getline(char *s, int len)
{
	int ch, i;
...
static void addpart(part_t parttab, geometry_t geom)
{
	char line[80];
	int off, noff, poff;
	int size, psize;
...
static void bootpart(part_t parttab)
{
	int partno, i;
...
static void delpart(part_t parttab)
{
	int ch, partno;
...
static int commit(part_t parttab, int devno)
{
	int ch, result;
...
static void parttype(part_t parttab)
{
	char line[80];
